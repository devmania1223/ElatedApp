//
//  FavoritesMyCollectionViewCell.swift
//  Elated
//
...
class FavoritesMyCollectionViewCell: UICollectionViewCell {
    
    static let identifier = "FavoritesMyCollectionViewCell"
    ...
    private lazy var stackview: UIStackView = {
        let view = UIStackView(arrangedSubviews: [sparkButton, cancelButton])
        view.spacing = 12
