//
//  SparkFlirtChatImageMeTableViewCell.swift
//  Elated
//
...
class SparkFlirtChatImageMeTableViewCell: UITableViewCell {
    
    static let identifier = "SparkFlirtChatImageMeTableViewCell"
