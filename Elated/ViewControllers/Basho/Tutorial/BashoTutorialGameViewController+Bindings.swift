//
//  BashoTutorialGameViewController+Bindings.swift
//  Elated
//
//  Created by Rey Felipe on 9/21/21.
//  Copyright © 2021 elatedteam. All rights reserved.
//

// NOTE: This is basically a copy of BashoGameViewControllerr+Bindings.swift
...
//            Util.setRootViewController(landingNav)
        ...
        viewModel.bashoWords.subscribe(onNext: { [weak self] words in
            ...
            self.bashoCollectionPlaceholderLabel.isHidden = data.count > 0 ? true : false
