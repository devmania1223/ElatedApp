...
class BashoTimesUpPopup: UIView {
    ...
    private let titleLabel: UILabel = {
        ...
        label.text = "basho.settings.timesUp".localized
        return label
    }()
    ...
    private let subLabel: UILabel = {
        ...
        label.textAlignment = .center
        label.numberOfLines = 0
        label.text = "basho.settings.timesUp.message".localized
        return label
    }()
    ...
    private let resetButton: UIButton = {
        let button = UIButton()
        button.setTitle("basho.settings.reset".localized, for: .normal)
    ...
    private let skipButton: UIButton = {
        let button = UIButton()
        button.setTitle("basho.settings.skip".localized, for: .normal)
