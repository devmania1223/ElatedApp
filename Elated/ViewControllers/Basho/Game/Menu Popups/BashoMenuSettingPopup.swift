//
//  BashoMenuSettingPopup.swift
//  Elated
//
//  Created by Marlon on 8/20/21.
...
class BashoMenuSettingPopup: UIView {
    ...
    private let titleLabel: UILabel = {
        ...
        label.text = "basho.settings.menu.title".localized
        return label
    }()
    ...
    private lazy var changeGameButton = createButton(text: "basho.settings.menu.button.changeGame")
    private lazy var viewTutorialButton = createButton(text: "basho.settings.menu.button.viewTutorial")
    private lazy var blockUserButton = createButton(text: "basho.settings.menu.button.blockUser")
    private lazy var endGameButton = createButton(text: "basho.settings.menu.button.endGame")
