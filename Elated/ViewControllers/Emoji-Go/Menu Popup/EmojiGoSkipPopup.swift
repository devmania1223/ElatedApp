...
class EmojiGoSkipPopup: UIView {
    ...
    private let titleLabel: UILabel = {
        ...
        label.text = "emojiGo.settings.turnSkipped.title".localized
        return label
    }()
    ...
    private let subLabel: UILabel = {
        ...
        label.textAlignment = .center
        label.numberOfLines = 0
        label.text = "emojiGo.settings.turnSkipped.message".localized
        return label
    }()
